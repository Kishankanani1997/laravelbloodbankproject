        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if(Session('deletesucc'))
                    <div class="alert alert-success alert-dismissible mt-3">
                        ...
                        <span class="text-dark">{{ session('deletesucc')}}</span>
                    </div>
                @endif
            ...
            @foreach($data as $row)
                ...
                <tr>
                    ...
                    <td>{{$row->allergy}}</td>
                    <td>{{$row->date}}</td>
                    <td><a href='{{ URL("/delete1/".$row->id)}}' onclick="return confirm('Are You Sure You Want to Delete The Donor?')"> <i class="bi bi-trash text-danger fw-bolder fs-3"></i></a></td>
                </tr>
            @endforeach
                </tbody>
            </table>
